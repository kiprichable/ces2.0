    ...
    <div class="col-lg-12">
        <div class="well">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="start" name="start_time" value="{{$start}}" required="" title="Selected time" placeholder="{{\Carbon\Carbon::now()}} " readonly>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="end" name="end_time" value="{{$end}}" required="" title="Selected time" placeholder="{{\Carbon\Carbon::now()}}" readonly>
                <p class="help-block"></p>
